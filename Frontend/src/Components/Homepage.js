    ...
    <div>
        ...
        <nav className="home-navbar">
          <div className="home-navbar-left">
            <div className="home-logo">
              <img src='/Assets/Images/Urban-Key.jpg' alt="Logo" />
            </div>
      ...
      <div className='footer'>
        <div className='footer-content'>
          ...
          <div className='footer-section'>
            <h2>About Us</h2>
            <p>UrbanKey  is dedicated to bringing you the best plots and houses to make your search of houses easy and happy. Join our community and enjoy the benefits today!</p>
          </div>
        </div>
        <div className='footer-bottom'>
          <p>&copy; {new Date().getFullYear()} UrbanKey. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
