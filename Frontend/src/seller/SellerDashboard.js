...
// Define shades of #d8232a
const propertyTypes = [
  { name: "Villas", count: 4, color: "#f05249" }, // Lighter shade
  { name: "Houses", count: 8, color: "#eb3e35" }, // Slightly lighter shade
  { name: "Plots", count: 12, color: "#d8232a" }, // Main color
  { name: "Commercial Buildings", count: 3, color: "#c51f27" }, // Slightly darker shade
  { name: "PG/Rentals", count: 6, color: "#b31c23" }, // Darker shade
];
